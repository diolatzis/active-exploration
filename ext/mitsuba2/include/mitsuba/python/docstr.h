...
static const char *__doc_mitsuba_BSDF_is_glossy = R"doc(Is the BSDF glossy?)doc";

static const char *__doc_mitsuba_BSDF_num_parameters = R"doc(Get the number of variable parameters.)doc";

static const char *__doc_mitsuba_BSDF_num_alternatives = R"doc(Get the number of possible reflectances.)doc";

static const char *__doc_mitsuba_BSDF_set_alternative = R"doc(Set alternative reflectance.)doc";

static const char *__doc_mitsuba_BSDF_set_modifier = R"doc(Set reflectance modifier.)doc";
...
static const char *__doc_mitsuba_Film_set_size = R"doc(Set the size of the film.)doc";
...
static const char* __doc_mitsuba_Shape_set_to_world = R"doc(Set the to world transformation.)doc";

static const char* __doc_mitsuba_Shape_num_parameters = R"doc(Get the number of variable parameters.)doc";

static const char* __doc_mitsuba_Shape_num_alternatives = R"doc(Get the number of alternative shapes.)doc";

static const char* __doc_mitsuba_Shape_set_alternative = R"doc(Set alternative shape.)doc";
...
static const char* __doc_mitsuba_Shape_set_world_transform = R"doc(Set the local space to world space transformation)doc";

static const char* __doc_mitsuba_Shape_world_transform = R"doc(Get the local space to world space transformation)doc";
...
static const char *__doc_mitsuba_SurfaceInteraction_is_emitter = R"doc(Is the intersected shape also an emitter?)doc";
