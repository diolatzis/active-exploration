...
public:
    ...
    void set_to_world(ScalarTransform4f to_world) {
        m_to_world = to_world*m_original_to_world;
...
protected:
    ...
    ScalarTransform4f m_original_to_world;
...
ENOKI_CALL_SUPPORT_TEMPLATE_BEGIN(mitsuba::Shape)
    ...
    ENOKI_CALL_SUPPORT_METHOD(set_obj_id)
    ENOKI_CALL_SUPPORT_METHOD(obj_id)
